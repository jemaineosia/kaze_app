...
class CashoutViewModel extends FormViewModel {
  ...
  Future<void> _initialize() async {
    ...
    try {
      ...
      _loggerService.error("Error initializing CashoutViewModel",
  ...
  void submit(
    ...
    try {
      ...
      _loggerService
          .info("Cashout request submitted for $selectedPaymentMode.");
      _navigationService.back();
    } catch (e, stackTrace) {
      _loggerService.error("Error submitting cashout request",
          error: e, stackTrace: stackTrace);
