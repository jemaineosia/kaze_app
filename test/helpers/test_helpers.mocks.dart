...
import 'package:kaze_app/services/firestore_service.dart' as _i9;
...
class MockAuthService extends _i1.Mock implements _i8.AuthService {
  @override
  _i6.Future<_i2.UserCredential> signInWithEmailPassword(
    String? email,
    dynamic password,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i6.Future<_i2.UserCredential> signUpWithEmailPassword(
    String? username,
    String? email,
    String? password,
  ) =>
